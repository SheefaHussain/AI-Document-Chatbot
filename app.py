...
def upload_file():
    ...
    if file:
        ...
        file_stream = io.BytesIO(file.read()) # Read file into an in-memory byte stream
        ...
        try:
            ...
            return jsonify({"message": "File processed successfully", "extracted_text": extracted_text}), 200
...
def ask_gemini():
    ...
    if not uploaded_document_text:
        return jsonify({"message": "No document uploaded yet. Please upload a file first."}), 400
